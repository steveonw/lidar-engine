#!/usr/bin/env python3
"""
lidar_studio.py — single-file web front-end for the LiDAR Lenses Wave engine.
...
<title>LiDAR Lenses Wave — Studio</title>
<style>
  ...
  * { box-sizing: border-box; }
  ...
  select, input[type=number], input[type=file] { width:100%; padding:8px 9px; background:#121a28;
